...
public class BoardController {
	 ...
	 * System.out.println("글 상세 조회 처리..");
	 * 
	 * // Model 정보 저장 model.addAttribute("board", boardDAO.getBoard(vo));
	 * 
	 * return "getBoard.jsp"; // View 이름을 리턴함
     * }
	 */
	...
	/*
	 * @RequestMapping("/getBoard.do") public 
	 * ModelAndView getBoard(BoardVO vo,BoardDAO boardDAO, ModelAndView mav) {
	 * 
	 * System.out.println("글 상세 조회 처리.."); 
